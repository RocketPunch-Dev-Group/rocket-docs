---
title: "Implement the OAuth 2.0 Authorization Flow"
sidebarTitle: "Auth Flow"
description: "Step-by-step guide to implementing OAuth 2.0 authorization code flow for the Rocketpunch API, from redirect to token exchange."
---
