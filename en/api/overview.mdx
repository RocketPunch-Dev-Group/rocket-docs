---
title: "Rocketpunch Open API: Build Apps on Talent Data"
sidebarTitle: "Overview"
description: "The Rocketpunch Open API gives developers programmatic access to jobs, companies, profiles, and events from Korea's leading tech talent network."
---
...
<CardGroup cols={2}>
  <Card title="Jobs" icon="briefcase" href="/en/api/reference/jobs">
  ...
  <Card title="Events" icon="calendar" href="/en/api/reference/events">
