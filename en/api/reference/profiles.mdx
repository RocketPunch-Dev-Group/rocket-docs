...
<Note>
  ...
  To set up OAuth and obtain user tokens, see the [OAuth Overview](/en/api/oauth/overview).
</Note>
    ...
    <ResponseField name="items[].current_company" type="object">
      ...
      <Expandable title="Current company fields">
        ...
        <ResponseField name="items[].current_company.handle" type="string">
          The Rocketpunch handle of the current employer, usable with the [Companies API](/en/api/reference/companies) for additional context.
        </ResponseField>
      </Expandable>
    </ResponseField>
  </Expandable>
