...
사용자 동의를 받아 API를 호출하기까지의 전 과정입니다. 시작하기 전에 [개발자 콘솔](https://openapis.rocketpunch.com/apps/new)에서 **OAuth 클라이언트 앱**을 등록하고 App Key · 시크릿 키 · 리다이렉트 URI를 준비해 주세요.
...
<Steps>
  ...
  <Step title="사용자를 동의 화면으로 보내기">
    ...
    ```
    https://openapis.rocketpunch.com/oauth/authorize
      ?response_type=code
